 ...
 */
class getProgrammebienetreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProgrammebienetreRepository' shared autowired service.
     *
     * @return \App\Repository\ProgrammebienetreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProgrammebienetreRepository.php';

        return $container->privates['App\\Repository\\ProgrammebienetreRepository'] = new \App\Repository\ProgrammebienetreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

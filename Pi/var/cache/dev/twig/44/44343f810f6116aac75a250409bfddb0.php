...
class __TwigTemplate_b7ce3a6ec34d6ead2bc9ab394214d448 extends Template
{
    ...
    <div class=\"tasks\">
        ...
        if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["taches"]) || array_key_exists("taches", $context) ? $context["taches"] : (function () { throw new RuntimeError('Variable "taches" does not exist.', 59, $this->source); })())) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tache"]) {
                ...
                // line 64
                yield ((CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "createdAt", [], "any", false, false, false, 64)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "createdAt", [], "any", false, false, false, 64), "d/m/Y"), "html", null, true)) : ("Not defined"));
                yield "</p>
                    <p><strong>Estimated Duration:</strong> ";
                // line 65
                yield ((CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "date", [], "any", false, false, false, 65)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "date", [], "any", false, false, false, 65) . " weeks"), "html", null, true)) : ("Not defined"));
                yield "</p>
...
$context["tache"], "isOverdue", [], "method", false, false, false, 69)) {
                    yield "overdue
                            ";
                } else {
                    // line 70
                ...
                // line 75
                yield ((CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "iduser", [], "any", false, false, false, 75)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "iduser", [], "any", false, false, false, 75), "nom", [], "any", false, false, false, 75) . " ") . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "iduser", [], "any", false, false, false, 75), "prenom", [], "any", false, false, false, 75)), "html", null, true)) : ("No user assigned"));
                yield "</p>
                    ";
                // line 76
                if (CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "completedAt", [], "any", false, false, false, 76)) {
                    // line 77
                    ...
                    // line 78
                    yield ((CoreExtension::getAttribute($this->env, $this->source, $context["tache"], "isCompletedEarly", [], "method", false, false, false, 78)) ? ("Yes") : ("No"));
                    yield "</p>
                    ";
                }
                // line 80

...
class __TwigTemplate_0e65773b9bbed4a24e4eb3731be3e2be extends Template
{
    ...
    {
        // line 4
        return $this->loadTemplate((((CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 4, $this->source); })()), "role", [], "any", false, false, false, 4) == "ADMIN")) ? ("sideBar.html.twig") : ("navBar.html.twig")), "user/profile.html.twig", 4);
    }
...
<style>
   ...
   ";
        // line 33
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 33, $this->source); })()), "imageUrl", [], "any", false, false, false, 33)) {
            // line 34
            yield "    <img src=\"";

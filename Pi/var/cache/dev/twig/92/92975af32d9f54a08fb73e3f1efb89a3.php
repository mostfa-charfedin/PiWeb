...
class __TwigTemplate_ac7f297b320cb1c582e705cace5ae932 extends Template
{
  ...
  <section class=\"section\">
    <div class=\"card\">
      <div class=\"card-body\">
        ...
        // line 55
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["task"]) || array_key_exists("task", $context) ? $context["task"] : (function () { throw new RuntimeError('Variable "task" does not exist.', 55, $this->source); })()), "completedAt", [], "any", false, false, false, 55)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, (isset($context["task"]) || array_key_exists("task", $context) ? $context["task"] : (function () { throw new RuntimeError('Variable "task" does not exist.', 55, $this->source); })()), "completedAt", [], "any", false, false, false, 55), "Y-m-d H:i"), "html", null, true)) : ("-"));
        yield "
          </li>
          <li class=\"list-group-item\">
            <strong>Overdue:</strong> ";
        // line 58
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["task"]) || array_key_exists("task", $context) ? $context["task"] : (function () { throw new RuntimeError('Variable "task" does not exist.', 58, $this->source); })()), "isOverdue", [], "method", false, false, false, 58)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Yes") : ("No"));
        yield "
          </li>
          <li class=\"list-group-item\">
            <strong>Completed Early:</strong> ";
        // line 61
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["task"]) || array_key_exists("task", $context) ? $context["task"] : (function () { throw new RuntimeError('Variable "task" does not exist.', 61, $this->source); })()), "isCompletedEarly", [], "method", false, false, false, 61)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Yes") : ("No"));
        yield "
          </li>
        </ul>

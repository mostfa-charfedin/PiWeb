...
class __TwigTemplate_a648a65bf25e9cafb4181194e2db8804 extends Template
{
    ...
    <div class=\"text-center mt-4\">
        <button type=\"submit\" class=\"btn btn-primary\">
            ...
            ";
        // line 29
        if ((($tmp = (isset($context["edit_mode"]) || array_key_exists("edit_mode", $context) ? $context["edit_mode"] : (function () { throw new RuntimeError('Variable "edit_mode" does not exist.', 29, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield "Update";
        } else {
            yield "Create";
        }

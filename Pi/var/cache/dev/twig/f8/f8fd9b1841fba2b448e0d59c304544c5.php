...
class __TwigTemplate_875f152bcbf5b4d16edee043e926abbb extends Template
{
...
(isset($context["formQuiz"]) || array_key_exists("formQuiz", $context) ? $context["formQuiz"] : (function () { throw new RuntimeError('Variable "formQuiz" does not exist.', 32, $this->source); })()), "nom", [], "any", false, false, false, 32), "vars", [], "any", false, false, false, 32), "errors", [], "any", false, false, false, 32)) > 0)) ? (" is-invalid") : ("")))]]);
        // line 34
        yield "
                <div class=\"invalid-feedback d-block\">
                  ";
        // line 36
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["formQuiz"]) || array_key_exists("formQuiz", $context) ? $context["formQuiz"] : (function () { throw new RuntimeError('Variable "formQuiz" does not exist.', 36, $this->source); })()), "nom", [], "any", false, false, false, 36), 'errors');
        yield "
                </div>
              </div>
              ...
              <div class=\"mb-4\">
                ";
        // line 41
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["formQuiz"]) || array_key_exists("formQuiz", $context) ? $context["formQuiz"] : (function () { throw new RuntimeError('Variable "formQuiz" does not exist.', 41, $this->source); })()), "datecreation", [], "any", false, false, false, 41), 'label');
        yield "
                ";
        // line 42
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["formQuiz"]) || array_key_exists("formQuiz", $context) ? $context["formQuiz"] : (function () { throw new RuntimeError('Variable "formQuiz" does not exist.', 42, $this->source); })()), "datecreation", [], "any", false, false, false, 42), 'widget', ["attr" => ["class" => ("form-control" . (((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 44
(isset($context["formQuiz"]) || array_key_exists("formQuiz", $context) ? $context["formQuiz"] : (function () { throw new RuntimeError('Variable "formQuiz" does not exist.', 44, $this->source); })()), "datecreation", [], "any", false, false, false, 44), "vars", [], "any", false, false, false, 44), "errors", [], "any", false, false, false, 44)) > 0)) ? (" is-invalid") : (""))), "min" => $this->extensions['Twig\Extension\CoreExtension']->formatDate("now", "Y-m-d"), "max" => $this->extensions['Twig\Extension\CoreExtension']->formatDate("now", "Y-m-d")]]);
        // line 48
        yield "
                <div class=\"invalid-feedback d-block\">
                  ";
        // line 50
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["formQuiz"]) || array_key_exists("formQuiz", $context) ? $context["formQuiz"] : (function () { throw new RuntimeError('Variable "formQuiz" does not exist.', 50, $this->source); })()), "datecreation", [], "any", false, false, false, 50), 'errors');
        yield "
                </div>
              </div>
        ...
        yield "\" class=\"btn btn-outline-secondary\">
                ...
                <button type=\"submit\" class=\"btn btn-primary\">
                  ";
        // line 59
        yield (((($tmp = (isset($context["edit_mode"]) || array_key_exists("edit_mode", $context) ? $context["edit_mode"] : (function () { throw new RuntimeError('Variable "edit_mode" does not exist.', 59, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Update Quiz") : ("Create Quiz"));
        yield "
                </button>
              </div>
            ...
            ";
        // line 63
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formQuiz"]) || array_key_exists("formQuiz", $context) ? $context["formQuiz"] : (function () { throw new RuntimeError('Variable "formQuiz" does not exist.', 63, $this->source); })()), 'form_end');
        yield "
          </div>
        </div>
      </div>
...
";
    ...
    {
        return array (  194 => 63,  187 => 59,  180 => 55,  172 => 50,  168 => 48,  166 => 44,  165 => 42,  161 => 41,  153 => 36,  149 => 34,  147 => 32,  146 => 30,  142 => 29,  136 => 26,  131 => 24,  118 => 14,  114 => 13,  108 => 10,  104 => 8,  91 => 7,  77 => 4,  64 => 3,  41 => 1,);
    }
          ...
          <div class=\"card-body p-4\">
            ...
            {{ form_start(formQuiz) }}
              ...
              <div class=\"mb-3\">
                ...
                {{ form_widget(formQuiz.nom, {
                  'attr': {
                    'class': 'form-control' ~ (formQuiz.nom.vars.errors|length > 0 ? ' is-invalid' : '')
                  }
                }) }}
                <div class=\"invalid-feedback d-block\">
              ...
              <div class=\"mb-4\">
                ...
                {{ form_widget(formQuiz.datecreation, {
                  'attr': {
                    'class': 'form-control' ~ (formQuiz.datecreation.vars.errors|length > 0 ? ' is-invalid' : ''),
                    'min': \"now\"|date(\"Y-m-d\"),
                    'max': \"now\"|date(\"Y-m-d\")
                  }
                }) }}
...
{% endblock %}", "quiz/QuizForm.html.twig", "C:\\Users\\akrim\\OneDrive\\Desktop\\PiWeb\\Pi\\templates\\quiz\\QuizForm.html.twig");
    }
}

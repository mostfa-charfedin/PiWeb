...
/* sideBar.html.twig */
class __TwigTemplate_45729df8c8bb17d1f9073807ff74bf3a extends Template
{
...
<body>
  ...
  <a class=\"nav-link nav-profile d-flex align-items-center pe-0\" href=\"#\" id=\"dropdownMenuLink\" role=\"button\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
    ";
        // line 55
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 55, $this->source); })()), "imageUrl", [], "any", false, false, false, 55)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 56
            yield "      <img src=\"";
    ...
    <!-- ✅ Quizzes moved up with updated icon -->
      <li class=\"nav-item\">
       ...
       <li class=\"nav-item\">
        <a class=\"nav-link\" href=\"";
        // line 132
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_score");
        yield "\">
            <i class=\"bi bi-question-circle\"></i>
 ...
 <!-- Vendor JS Files -->
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    {
        return array (  373 => 162,  344 => 181,  338 => 178,  334 => 177,  330 => 176,  326 => 175,  322 => 174,  318 => 173,  313 => 171,  309 => 170,  300 => 163,  298 => 162,  285 => 152,  275 => 145,  265 => 138,  256 => 132,  247 => 126,  236 => 118,  228 => 113,  208 => 96,  179 => 70,  174 => 68,  168 => 65,  162 => 64,  152 => 60,  146 => 58,  140 => 56,  138 => 55,  124 => 44,  105 => 28,  99 => 25,  95 => 24,  91 => 23,  87 => 22,  83 => 21,  79 => 20,  75 => 19,  67 => 14,  63 => 13,  49 => 1,);
    }
 ...
 <li class=\"nav-item\">
    ...
    <!-- ✅ Quizzes moved up with updated icon -->
      <li class=\"nav-item\">
       ...
       <li class=\"nav-item\">
        <a class=\"nav-link\" href=\"{{ path('app_score') }}\">
            <i class=\"bi bi-question-circle\"></i>
          <span>Scores list</span>
        </a>
      </li>

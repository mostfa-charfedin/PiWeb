...
class Projet extends \App\Entity\Projet implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Projet' . "\0" . 'idprojet', '' . "\0" . 'App\\Entity\\Projet' . "\0" . 'titre', '' . "\0" . 'App\\Entity\\Projet' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Projet' . "\0" . 'iduser'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTitre(?string $titre): \App\Entity\Projet
    {
     ...
     * {@inheritDoc}
     */
    public function setIduser($iduser): \App\Entity\Projet
    {
